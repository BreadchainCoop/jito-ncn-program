...
/// Consensus threshold in bps of total snapshot stake.
///
/// PRE-PHASE-1 STAND-IN: once Track A lands `Config.consensus_threshold_bps`
/// (admin-settable, default 6667), the settle path reads the config field and
/// this constant becomes the default only.
